                ...
                <div class="container-fluid" style="padding-left: 0;padding-right: 0;">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" style="font-size: 24px;">
                                <ul class="nav navbar-nav">
                                        <li <?php echo $page == "acasa" && $view == "dashboard" ? 'class="active"' : ""; ?>><a href="<?php echo _SITE_BASE; ?>"><i class="fa fa-home"></i> Acasa</a></li> 
                                        <li <?php echo $page == "users" && $view == "dashboard" ? 'class="active"' : ""; ?>><a href="<?php getUrl("users", "dashboard", true); ?>"><i class="fa fa-home"></i> Users</a></li> 
                                </ul>
                                <ul class="nav navbar-nav navbar-right">
                                        <li class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" style="z-index: 1000;">
                                                        ...
                                                        <li><a href="#"><i class="fa fa-question-circle"></i> Despre</a></li>
